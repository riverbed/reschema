...
latex_documents = [
  ('index', 'reschema.tex', u'reschema Documentation',
...
man_pages = [
    ('index', 'reschema', u'reschema Documentation',
...
texinfo_documents = [
  ('index', 'reschema', u'reschema Documentation',
   u'Christopher J. White (cwhite@riverbed.com)', 'reschema', 'One line description of project.',
   'Miscellaneous'),
]
