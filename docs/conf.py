...
latex_documents = [
  ('index', 'reschema.tex', 'reschema Documentation',
...
man_pages = [
    ('index', 'reschema', 'reschema Documentation',
...
texinfo_documents = [
  ('index', 'reschema', 'reschema Documentation',
   'Christopher J. White (cwhite@riverbed.com)', 'reschema', 'One line description of project.',
   'Miscellaneous'),
]
